...
interface RemoveUserFromTeamPageProps {}

const RemoveUserFromTeamPage: React.FC<RemoveUserFromTeamPageProps> = () => {
    ...
    const handleRemoveUserFromTeam = async (event: React.FormEvent) => {
    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-md w-80">
                ...
                <form onSubmit={handleRemoveUserFromTeam}>
                    <input
...
export default RemoveUserFromTeamPage;