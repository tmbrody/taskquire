...
interface AddTeamToProjectPageProps {}

const AddTeamToProjectPage: React.FC<AddTeamToProjectPageProps> = () => {
    ...
    const handleAddTeamToProject = async (event: React.FormEvent) => {
        ...
        router.push(`http://localhost:3000/orgs/${orgName}/projects/${projectName}/teams`)
    }
    ...
    return (
        <div className="bg-gray-900 min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="bg-gray-800 p-8 rounded-lg shadow-md w-80">
                ...
                <form onSubmit={handleAddTeamToProject}>
                    <input
...
export default AddTeamToProjectPage;